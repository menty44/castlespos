...
LDLIBSOPTIONS=-lctosapi -lcaethernet -lcafont -lcafs -lcakms -lcalcd -lcamodem -lcapmodem -lcaprt -lcartc -lcauart -lcauldpm -lcausbh -lcagsm -lcabarcode -lpthread -ldl -lcaclvw -lcatls -lcrypto -lcurl -lssl -lz -lfreetype -lcaclmdl -lcaclentry -lcampp -lcavpw -lcaemvl2 -lcaemvl2ap -lbmp -lcasignature

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk dist/V3/App/V3_Qt_Demo.exe

dist/V3/App/V3_Qt_Demo.exe: ${OBJECTFILES}
	${MKDIR} -p dist/V3/App
	arm-brcm-linux-gnueabi-g++ -L . "-L${SDKV3LIB}" "-L${SDKV3LIBN}" -o dist/V3/App/V3_Qt_Demo  ${OBJECTFILES} ${LDLIBSOPTIONS} 
