...
LDLIBSOPTIONS=-lcaethernet -lcafont -lcafs -lcakms -lcalcd -lcamodem -lcapmodem -lcaprt -lcartc -lcauart -lcauldpm -lcausbh -lcagsm -lcabarcode -lpthread -ldl -lcaclvw -lcatls -lctosapi -lcrypto -lcurl -lssl -lz -lfreetype -lcaaep -lcavap -lcaclentry -lcaclmdl -lcaemvl2 -lcaemvl2ap -lcampp -lcavpw -lcapcipad -lbmp -lcasignature -lcapciutility

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk dist/V3/App/V3_Demo_V3P_35.exe

dist/V3/App/V3_Demo_V3P_35.exe: ${OBJECTFILES}
	${MKDIR} -p dist/V3/App
	arm-brcm-linux-gnueabi-g++ -L . "-L${SDKV3LIB}" "-L${SDKV3LIBN}" -o dist/V3/App/V3_Demo_V3P_35  ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/EMVCL-Redirect/Printer.o: EMVCL-Redirect/Printer.c 
	${MKDIR} -p ${OBJECTDIR}/EMVCL-Redirect
	$(COMPILE.c) -O2 -I/cygdrive/C/Program\ Files/Castles/VEGA3000/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA3000/include -o ${OBJECTDIR}/EMVCL-Redirect/Printer.o EMVCL-Redirect/Printer.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} dist/V3/App/V3_Demo_V3P_35.exe
