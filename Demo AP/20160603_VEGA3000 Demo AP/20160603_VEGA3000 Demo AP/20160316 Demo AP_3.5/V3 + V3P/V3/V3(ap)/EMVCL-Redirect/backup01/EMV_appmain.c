...
int EMV_Contactless_main(void) {
    ...
    while (1) {
        ...
        TopRelative_LCDTPrintY_RightAlign(g_ScreenSize_Y - g_usScreenTopOffset, "X-Exit");
        TopRelative_LCDTPrintXY(1, 2, "1. Contact      ");
        TopRelative_LCDTPrintXY(1, 3, "2. Contactless  ");
        ...
        if (bKey == '1') {
            ...
            EMVCL_SetDebug(TRUE, d_DEBUG_PORT_USB);
            __DebugInit();
            ...
            if (ulRtn != 0) {
                ShowRtn(1, "EMVCL Init Fail ", ulRtn);
                ForceMainDevice_KBDGet(&bKey);
                goto END;
            }
