...
void PageClean(void)
{
	...
	ClearScreen(3, g_ScreenSize_Y - g_usScreenTopOffset - 1 );
...
void PageShow(USHORT PageNo)
{
	...
	switch(PageNo)
	{
		...
		{
			PageClean();
			TopRelative_LCDTPrintXY(1, 3, " Present Card   ");
		...
		case d_PAGE_TRANSACTION_NO_CARD_AND_USE_OTHER_CARD :
		{
			...
			ShowRtn(3, g_str, g_ulDisplayPara[0]);
			break;
		}
		case d_PAGE_TRANSACTION_ENTER_ONLINE_PIN :
		{
			TopRelative_LCDTPrintXY(1, 3, "Enter ONL PIN :");
			break;
		}
		case d_PAGE_TRANSACTION_PIN_BY_PASS :
		{
			TopRelative_LCDTPrintXY(1, 4, "PIN By Pass");
			break;
		}
		...
		case d_PAGE_TRANSACTION_OUTCOME_OFFLINE_APPROVAL :
		{
			...
			TopRelative_LCDTPrintXY(1, 4, " [Off Approval] ");
			TopRelative_LCDTPrintXY(1, 5, g_str2);
			break;
		}
		case d_PAGE_TRANSACTION_OUTCOME_OFFLINE_DECLINED:
		{
			TopRelative_LCDTPrintXY(1, 4, " [Off Declined] ");
			TopRelative_LCDTPrintXY(1, 5, g_str);
			break;
		}
		case d_PAGE_TRANSACTION_OUTCOME_GO_ONL :
		{
			TopRelative_LCDTPrintXY(1, 4, " Go Online...  ");
...
//                        TopRelative_LCDTPrintXY(1, 8, "                     ");
		...
		{
			TopRelative_LCDTPrintXY(1, 3, g_str);
			TopRelative_LCDTPrintXY(1, 4, " [ONL Approval] ");
			TopRelative_LCDTPrintXY(1, 5, g_str2);			
			break;
		}
...
//					strcpy(g_str, "Sale Txn");
		...
		{
			PageClean();
			TopRelative_LCDTPrintXY(1, 3, "Input Amt\n");
			TopRelative_LCDTPrintXY(1, 4, "( 0...9999999 )");
//                        TopRelative_LCDTPrintXY(1, 7, "                     ");
//                        TopRelative_LCDTPrintXY(1, 8, "                     ");
			break;
		}	
		...
		{
			PageClean();
			TopRelative_LCDTPrintXY(1, 3, "Input CB Amt\n");
			TopRelative_LCDTPrintXY(1, 4, "( 0...9999999 )");
			break;
		}	
